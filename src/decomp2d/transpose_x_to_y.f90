...
#ifdef GPTL
    ret = gptlstop('----mem_split_xy')
#endif

#ifdef GPTL
    ret = gptlstart('----mpi_alltoall_xy')
#endif
...
#ifdef GPTL
    ret = gptlstop('----mpi_alltoall_xy')
    ret = gptlstart('----mem_merge_xy')
#endif
