...
#ifdef GPTL
    ret = gptlstop('----mem_split_zy')
#endif

#ifdef GPTL
    ret = gptlstart('----mpi_alltoall_zy')
#endif
...
#ifdef GPTL
    ret = gptlstop('----mpi_alltoall_zy')
    ret = gptlstart('----mem_merge_zy')
#endif
